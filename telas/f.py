...
def criar_tela_catalogo(parent, voltar_callback=None, confirmar_callback=None):
    ...
    frame_imagem = ctk.CTkFrame(frame_top, width=200, height=300)
    ...
    label_sinopse = ctk.CTkLabel(frame_textos, textvariable=sinopse_var, wraplength=600, justify="left")
    ...
    def criar_botoes_filmes():
        ...
        for filme in filmes:
            ...
            item_frame = ctk.CTkFrame(scrollable_frame, fg_color=FILME_NORMAL_COLOR, height=230, width=160, corner_radius=8)
