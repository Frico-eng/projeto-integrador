...
('Avatar', 'Ficção Científica, Aventura', '2h 17m', '12', 'utilidades/images/avatar.jpg', 'James Cameron', 'Em um futuro distante, um ex-marine paraplégico é enviado a Pandora, um mundo extraterrestre habitado por seres azuis chamados Navi. Ele deve navegar por este mundo estranho e ameaçador para cumprir sua missão.'),
